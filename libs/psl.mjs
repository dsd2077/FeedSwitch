...
function $() {
  ...
  const G = (a) => String.fromCodePoint(...a),
    W = function (a) {
    ...
    T = function (a, i, m) {
      let n = 0
      for (a = m ? h(a / d) : a >> 1, a += h(a / i); a > (_ * o) >> 1; n += s) a = h(a / _)
...
const A = /* @__PURE__ */ U(J),
  ...
  O = (e) => {
    ...
    const d = () => (/xn--/.test(s) && (o.domain && (o.domain = A.toASCII(o.domain)), o.subdomain && (o.subdomain = A.toASCII(o.subdomain))), o),
      z = X(s)
    ...
    return (
      ...
      (o.tld = y.join(".")),
      !g.length || (z.wildcard && (y.unshift(g.pop()), (o.tld = y.join("."))), !g.length) || ((o.sld = g.pop()), (o.domain = [o.sld, o.tld].join(".")), g.length && (o.subdomain = g.join("."))),
      d()
    )
  },
...
export { na as default, Y as errorCodes, aa as get, oa as isValid, O as parse }
